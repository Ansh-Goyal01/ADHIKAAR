...
export const ml: UiDict = {
  ...
  "results": {
    ...
    "checklistLead": "മുകളിലെ പദ്ധതികൾ ആവശ്യപ്പെടുന്ന എല്ലാ രേഖകളും ഒറ്റ പട്ടികയിൽ — ശേഖരിച്ചവ ടിക് ചെയ്യുക. അച്ചടിച്ച റിപ്പോർട്ടിലെ ഒഴിഞ്ഞ കള്ളികൾ ഓഫീസിലേക്ക് കൊണ്ടുപോകാവുന്ന ചെക്ക്‌ലിസ്റ്റാകുന്നു."
  },
  "whatIf": {
    "title": "സാഹചര്യം മറ്റൊന്നായിരുന്നെങ്കിൽ?",
    "lead": "മറ്റൊരു പ്രായം, വരുമാനം അല്ലെങ്കിൽ BPL കാർഡ് പരീക്ഷിച്ച് ഏതു വിധികൾ മാറുമെന്ന് കാണുക — അതേ ഔദ്യോഗിക നിയമങ്ങൾ കൊണ്ടുതന്നെ പരിശോധന. മുകളിലെ റിപ്പോർട്ട് അതേപടി നിലനിൽക്കും; ഒന്നും സൂക്ഷിക്കപ്പെടുന്നില്ല.",
    "age": "പ്രായം",
    "income": "വാർഷിക കുടുംബ വരുമാനം (₹)",
    "bplCard": "BPL കാർഡ് ഉണ്ട്",
    "run": "എന്തു മാറുന്നു എന്നു കാണുക",
    "running": "നിയമങ്ങൾ പരിശോധിക്കുന്നു…",
    "noChange": "ഈ മൂല്യങ്ങൾ കൊണ്ട് ഒരു വിധിയും മാറുന്നില്ല.",
    "changesHeading": "മാറുന്ന വിധികൾ",
    "error": "സിമുലേഷൻ പ്രവർത്തിപ്പിക്കാനായില്ല. വീണ്ടും ശ്രമിക്കുക."
  },
  "feedback": {
    "title": "ഈ റിപ്പോർട്ടിലെ പ്രശ്നം അറിയിക്കുക",
    "lead": "തെറ്റായ വിധി, മോശം വിവർത്തനം അല്ലെങ്കിൽ കാലഹരണപ്പെട്ട രേഖാ പട്ടിക കണ്ടോ? ഞങ്ങളോട് പറയൂ — അത് നേരിട്ട് പരിപാലകരിലേക്ക് എത്തുന്നു.",
    "category": "ഏതു തരം പ്രശ്നം?",
    "categories": {
      "wrong_verdict": "ഒരു വിധി തെറ്റാണെന്ന് തോന്നുന്നു",
      "missing_scheme": "ഒരു പദ്ധതി വിട്ടുപോയി",
      "translation": "വിവർത്തനം ശരിയല്ല",
      "documents": "രേഖകളോ ഘട്ടങ്ങളോ കാലഹരണപ്പെട്ടതാണ്",
      "other": "മറ്റെന്തെങ്കിലും"
    },
    "scheme": "ഏതു പദ്ധതി?",
    "schemeNone": "ഒരു പദ്ധതിയെക്കുറിച്ചല്ല",
    "message": "എന്താണ് തെറ്റിയത്?",
    "noPii": "ദയവായി നിങ്ങളുടെ പേര്, ഫോൺ അല്ലെങ്കിൽ തിരിച്ചറിയൽ നമ്പറുകൾ എഴുതരുത് — റിപ്പോർട്ടുകൾ അജ്ഞാതമാണ്; തിരിച്ചറിയൽ വിവരങ്ങൾ സ്വയമേവ നീക്കം ചെയ്യപ്പെടും.",
    "submit": "റിപ്പോർട്ട് അയയ്ക്കുക",
    "sending": "അയയ്ക്കുന്നു…",
    "sent": "നന്ദി — നിങ്ങളുടെ റിപ്പോർട്ട് രേഖപ്പെടുത്തി.",
    "error": "നിങ്ങളുടെ റിപ്പോർട്ട് അയയ്ക്കാനായില്ല. വീണ്ടും ശ്രമിക്കുക."
  },
  "card": {
