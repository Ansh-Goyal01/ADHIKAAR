    ...
    <Container className="flex max-w-3xl flex-col gap-12 py-10 sm:py-14">
      <div className="flex flex-col gap-4">
        ...
        <p className="leading-relaxed text-muted-foreground">
          ...
          question — <em>&ldquo;what am I entitled to?&rdquo;</em> — for{" "}
          {SCHEME_COUNT} central schemes, in plain language, with every claim
          traceable to the government&rsquo;s own text. It would rather say
          &ldquo;not sure, ask this at the office&rdquo; than be confidently wrong.
        </p>
      </div>
